...
function useActionData() {
  ...
  let route = React.useContext(RouteContext);
  !route ? false ? invariant(false, "useActionData must be used inside a RouteContext") : invariant(false) : void 0;
...
function useSubmitFetcher(fetcherKey, fetcherRouteId) {
  ...
  return React2.useCallback(function(target, options) {
    ...
    !(fetcherRouteId != null) ? false ? invariant(false, "No routeId available for useFetcher()") : invariant(false) : void 0;
...
function useFetcher() {
  ...
  let [Form2] = React2.useState(() => {
    !routeId ? false ? invariant(false, "No routeId available for fetcher.Form()") : invariant(false) : void 0;
    return createFetcherForm(fetcherKey, routeId);
  });
  let [load] = React2.useState(() => (href) => {
    !router ? false ? invariant(false, "No router available for fetcher.load()") : invariant(false) : void 0;
